...
* Starting at 0 deg, this function will set the velocity to reach 45 deg.
* If 45 deg have been reached the function will try to reach -45 deg.
* Then it will indefintely cycle between 45 and -45 deg.
*/
...
void oscillate_PI_status(const asn1SccBase_commands_Joints *IN_sample)
{
    ...
    float position_ref = (state == REACH45N) ? 45.f : -45.f;
